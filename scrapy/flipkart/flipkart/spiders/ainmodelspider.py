...
class amazonInmodelSpider(Spider):
    ...
    baseUrl = "http://www.amazon.in/s/ref=lp_1389432031_pg_2?rh=n%3A976419031%2Cn%3A%21976420031%2Cn%3A1389401031%2Cn%3A1389432031&page="
    tailUrl = "&ie=UTF8&qid=1478051611"
    currentStart = 1
    parseStep = 1
    rc = re.compile("[0-9,]+")
