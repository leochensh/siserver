...
class jumiaMSpider(Spider):
    ...
    baseUrl = "https://www.jumia.com.ng/smartphones/?page="
    ...
    def parse(self, response):
        ...
        productList = response.xpath('//section[contains(@class,"products")]/div[contains(@class,"sku")]')

        for product in productList:

            # productTitleSel = product.xpath('div[contains(@class,"pu-title")]/a[contains(@class,"fk-display-block")]')
            productTitleSel = product.xpath(
                'a[contains(@class,"link")]/h2[contains(@class,"title")]/span[contains(@class,"name")]/text()')
            productBrandSel = product.xpath(
                'a[contains(@class,"link")]/h2[contains(@class,"title")]/span[contains(@class,"brand")]/text()')
            productHrefSel = product.xpath('a[contains(@class,"link")]/@href')
            ...
            if len(productBrandSel)>0:
                tmpbrand = productBrandSel[0].extract().strip()
                brand = tmpbrand
