...
class snapDealMSpider(Spider):
    name = "snapdealmspider"
    ...
    baseUrl = "https://www.snapdeal.com/acors/json/product/get/search/175/"
    # tailUrl = "&ajax=true&_=1473814010323"
    tailUrl = "/20?q=Form_s%3ASmartphones%7C&sort=plrty&brandPageUrl=&keyword=&searchState=categoryRedirected=mobiles-mobile-phones|previousRequest=true|serviceabilityUsed=false|filterState=null&pincode=&vc=&webpageName=categoryPage&campaignId=&brandName=&isMC=false&clickSrc=unknown&showAds=true&cartId="
    currentStart = 0
    parseStep = 20
    # rc = re.compile("[0-9,]+")
    #
    ...
    def parse(self, response):
        ...
        for product in productList:
            ...
            productTitleSel = product.xpath('div/div/a[contains(@class,"dp-widget-link") and contains(@class,"noUdLine")]/p[contains(@class,"product-title")]/text()')
            productHrefSel = product.xpath('div/div/a[contains(@class,"dp-widget-link") and contains(@class,"noUdLine")]/@href')
